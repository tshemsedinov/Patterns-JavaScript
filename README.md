...
- 🧩 Патерни
  ...
  - 🤝 Структурні шаблони
    ...
    - [Легковаговик (Flyweight)](https://github.com/HowProgrammingWorks/Flyweight) — економія пам'яті для групи об'єктів через доступ до спільного (розділюваного) стану в конкретному екземплярі.
    - [Context](https://github.com/HowProgrammingWorks/Context) — обмін станом та зележностями між рідними компонентами (абстракціями, модулями, шарами), що не мають спільного середовища, без жорсткого їх зчеплення.
  - ⚡ Шаблони поведінки
