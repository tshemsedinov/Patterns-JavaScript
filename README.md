...
- 🧩 Патерны
  ...
  - ⚡ Поведенческие шаблоны
    ...
    - [Service Locator](https://github.com/HowProgrammingWorks/ServiceLocator) - центральний реєстр сервісів, який дозволяє нам реєструвати та отримувати абстракції між модулями (використовується для впровадження залежностей, в js це можна реалізувати через систему модулів ESM або CJS).
