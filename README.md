...
- 🗃️ Шаблоны доступа к данным
    ...
    - Data access object (DAO) — абстракция, определяющая интерфейс для сохранения и извлечения доменных объектов, изолируя доменную логику от конкретных реализаций хранилища.
    ...
    - См. другие шаблоны: Template method, Actor, State, Memento
